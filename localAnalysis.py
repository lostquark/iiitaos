...
print("*"*100)
print("Starting live OS prediction. Press ctrl^C to stop capture")
print("*"*100)
...
for packet_number, packet in enumerate(capture):
    if 'TCP' in packet and 'IP' in packet:
        ...
        if int(packet['TCP'].flags_syn) == 1:
            ...
            # Print the results
            print(f'Source IP: {src_ip}, Predicted OS: {predicted_label[0]}, Predicted Major Version: {major_version}, Predicted Minor Version: {minor_version}')
